/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: bd14993fd665c3727cf847dd2a862361)
...
declare namespace Cloudflare {
	interface Env {
		...
		DURABLE_OBJECT: DurableObjectNamespace<import("./worker").ExcalidrawWebSocketServer>;
		DB: D1Database;
	}
}
