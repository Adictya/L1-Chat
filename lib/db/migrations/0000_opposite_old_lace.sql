...
--> statement-breakpoint
ALTER TABLE "chat_input" ADD CONSTRAINT "chat_input_chat_id_conversation_id_fk" FOREIGN KEY ("chat_id") REFERENCES "public"."conversation"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "chat_message" ADD CONSTRAINT "chat_message_chat_id_conversation_id_fk" FOREIGN KEY ("chat_id") REFERENCES "public"."conversation"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
