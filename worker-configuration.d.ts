/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: ea265b3eb8054b1adc313756e2e1cc6f)
// Runtime types generated with workerd@1.20250604.0 2025-06-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OPENAUTH_KV: KVNamespace;
		FRONTEND_URL: "http://localhost:3000" | "https://l1chat.adictya.workers.dev";
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		DURABLE_OBJECT: DurableObjectNamespace<import("./apps/server/worker").ExcalidrawWebSocketServer>;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FRONTEND_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
